...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=VT323&family=Caveat:wght@600;700&family=Quicksand:wght@400;500;600;700&family=Bagel+Fat+One&display=swap" },
    ],
  }),
